...
export async function POST(request: NextRequest) {
  try {
    ...
    const { token, repoName, bookConfig } = body;
...
function generateMystConfig(bookConfig: BookConfig): string {
  ...
  return `# MyST Configuration
# Generated by Book Builder
...
function generateGitHubWorkflow(): string {
  ...
  return `# MyST GitHub Pages Deploy
# Generated by Book Builder
  ...
  return JSON.stringify(
    {
      ...
      keywords: ['myst', 'jupyter-book', 'documentation'],
